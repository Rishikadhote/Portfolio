...
const skills = [
  ...
  },
  {
    category: "Interests",
    items: [
      { name: "Full Stack Development", icon: "devicon-javascript-plain" },
      { name: "Machine Learning", icon: "devicon-python-plain" },
      { name: "Software Development", icon: "devicon-git-plain" },
    ],
  },
  {
    category: "Skills",
    items: [
      { name: "Graphic Designing", icon: "devicon-git-plain" },
      { name: "Photoshop", icon: "devicon-git-plain" },
